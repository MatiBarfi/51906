...
5,4,0,0,39,40,3,14,7,0,40,41,5,5,0,0,41,42,5,6,0,0,42,43,3,8,4,0,43,49,5,
7,0,0,44,45,5,3,0,0,45,46,5,6,0,0,46,47,3,8,4,0,47,48,5,7,0,0,48,50,1,0,
...
56,55,1,0,0,0,57,9,1,0,0,0,58,59,5,2,0,0,59,60,5,4,0,0,60,61,3,16,8,0,61,
62,5,5,0,0,62,63,5,8,0,0,63,11,1,0,0,0,64,65,5,9,0,0,65,66,5,8,0,0,66,13,
1,0,0,0,67,70,5,10,0,0,68,70,5,11,0,0,69,67,1,0,0,0,69,68,1,0,0,0,70,15,
1,0,0,0,71,72,5,13,0,0,72,73,3,18,9,0,73,74,5,15,0,0,74,17,1,0,0,0,75,76,
...
1,0,0,0,85,89,5,16,0,0,86,89,5,17,0,0,87,89,5,18,0,0,88,85,1,0,0,0,88,86,
...
export default class AnalizadorParser extends antlr4.Parser {
    ...
    static literalNames = [ null, "'if'", "'printf'", "'else'", "'('", "')'", 
                            "'{'", "'}'", "';'", "'return'", "'0'", "'1'" ];
    static symbolicNames = [ null, "IF", "PRINTF", "ELSE", "LPARENT", "RPARENT", 
                             "LCBRACES", "RCBRACES", "SEMICOLON", "RETURN", 
                             "CERO", "UNO", "WS", "LDCOMILLA", "STRING_MODE_ESPACIO", 
	...
	cadena() {
	    ...
	    try {
	        ...
	        this.caracteres(0);
	        this.state = 73;
	        this.match(AnalizadorParser.LDCOMILLA_END);
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
		        localctx.exception = re;
		        this._errHandler.reportError(this, re);
...
AnalizadorParser.PRINTF = 2;
AnalizadorParser.ELSE = 3;
AnalizadorParser.LPARENT = 4;
AnalizadorParser.RPARENT = 5;
AnalizadorParser.LCBRACES = 6;
AnalizadorParser.RCBRACES = 7;
AnalizadorParser.SEMICOLON = 8;
AnalizadorParser.RETURN = 9;
AnalizadorParser.CERO = 10;
AnalizadorParser.UNO = 11;
AnalizadorParser.WS = 12;
AnalizadorParser.LDCOMILLA = 13;
AnalizadorParser.STRING_MODE_ESPACIO = 14;
AnalizadorParser.LDCOMILLA_END = 15;
AnalizadorParser.LETRA = 16;
...
class Cadena1Context extends CadenaContext {
	...
	LDCOMILLA() {
	    return this.getToken(AnalizadorParser.LDCOMILLA, 0);
	};
	...
	LDCOMILLA_END() {
	    return this.getToken(AnalizadorParser.LDCOMILLA_END, 0);
	};
